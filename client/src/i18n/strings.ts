...
const en = {
  ...
  'nav.ap': 'Money I Owe',
  'nav.cashbook': 'Cash & Bank Book',
  'nav.partyLedger': 'Party Statement',
  'nav.paymentAccounts': 'Money Accounts',
...
const bn: Record<StringKey, string> = {
  ...
  'nav.cashbook': 'নগদ ও ব্যাংক বই',
  'nav.partyLedger': 'পার্টি লেজার',
  'nav.paymentAccounts': 'টাকার হিসাবসমূহ',
